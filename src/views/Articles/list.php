...
?>
	...
	foreach($articles as $article){?>
		<tr>
			<td><img src="<?php echo App::getBaseUrl();?>/assets/images/articles/<?php echo $article->picture;?>" alt="<?php echo $article->title;?>" /></td>
			<td><a href="<?php echo App::getBaseUrl();?>/Articles/view?id=<?php echo $article->primaryKey;?>"><?php echo $article->title;?></a></td>
			<td class="prix"><?php echo number_format($article->price, 2);?></td>
			<td><a href="<?php echo App::getBaseUrl();?>/basket?action=add&amp;id=<?php echo $article->primaryKey;?>">Ajouter au panier</a></td>
		</tr><?php
	}
}?>
</table>
